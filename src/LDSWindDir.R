...
ggplot(frequencyDataFrame87, aes(x = Value, y = Freq)) +
  ...
  labs(title = "Camborne Cardinal Wind Directions (1987)",
       x = "Direction", y = "Frequency") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
ggsave("./exported/LDS/CardinalWindCamborne/CardinalWind1987.png", width = 16, height = 9, device="png", dpi=1600)
...
ggplot(frequencyDataFrame15, aes(x = Value, y = Freq)) +
  geom_bar(stat = "identity", fill = "skyblue", color = "black") +
  labs(title = "Camborne Cardinal Wind Directions (2015)",
       x = "Direction", y = "Frequency") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
ggsave("./exported/LDS/CardinalWindCamborne/CardinalWind2015.png", width = 16, height = 9, device="png", dpi=1600)
...
ggplot(completeDataset, aes(x = Value, y = Freq, fill = DS)) +
  ...
  labs(title = "Camborne Cardinal Wind Direction (1987/2015)",
       x = "Direction", y = "Frequency") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
ggsave("./exported/LDS/CardinalWindCamborne/CardinalWindCombined.png", width = 16, height = 9, device="png", dpi=1600)
